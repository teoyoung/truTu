...
exports.allBooksDBMessage = exports.TopMessage = exports.AddBookMessage = exports.message_incorrect_name_book = exports.message_incorrect_id = exports.message_incorrect_key = exports.message_start = void 0;
const admin = '@MikhaylovFedor';
exports.message_start = `
Добро пожаловать!

*Библиотекарь* — 🤖 бот, который поможет Вам не потерять свою книгу в нашей библиотеке, а так же не забыть вернуть её на место.
Миссия бота наполнить библиотеку хорошими, полезными и интересными книгами, которые по тем или иным причинам наши коллеги не решаются принести.
...
3. С помощью команды /add зарегистрируйте вашу книгу (уникальный ID и название в свободной форме). Код для добавления висит в зоне видимости возле книг.
...
`;
exports.message_incorrect_name_book = `
📙 Не забудь добавить название книги.
Пример:
/add 0001 secretKey Маленький принц
`;
function AddBookMessage(mode, data) {
...
exports.AddBookMessage = AddBookMessage;
function TopMessage(header, top) {
    return `
${header}
...
function allBooksDBMessage(name_book, itHave) {
    return `
«${name_book}»
${itHave}
----
...
exports.allBooksDBMessage = allBooksDBMessage;
